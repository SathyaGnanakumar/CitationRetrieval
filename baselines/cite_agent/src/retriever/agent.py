...
class LLMSelfAskAgentPydantic(BaseAgent):
    ...
    prompts = {
        "zero_shot_search": [_prompt_templates_dir / "zero_shot_search.txt", 0],
        "one_shot_search": [_prompt_templates_dir / "one_shot_search.txt", 0],
        "few_shot_search": [_prompt_templates_dir / "few_shot_search.txt", 1],
        "few_shot_search_no_read": [
            _prompt_templates_dir / "few_shot_search_no_read.txt",
            0,
        ],
    }
    human_intros = [
...
class LLMNoSearch(BaseAgent):
    ...
    prompts = {
        "zero_shot_no_search": _prompt_templates_dir / "zero_shot_no_search.txt",
        "few_shot_no_search": _prompt_templates_dir / "few_shot_no_search.txt",
    }
