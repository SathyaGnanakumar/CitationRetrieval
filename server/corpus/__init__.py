"""
corpus package for retrieval evaluation.

This package contains dataset loaders and preprocessing utilities
for various academic paper corpus used in retrieval evaluation.
"""

from corpus.scholarcopilot import (
    build_citation_corpus,
    clean_text,
    iter_citations,
    load_dataset,
)
from corpus.scholarcopilot.query_extraction import (
