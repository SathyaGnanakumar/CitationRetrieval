...
from url.src.agents.retrievers.bm25 import bm25_agent
from url.src.agents.retrievers.e5 import e5_agent
from url.src.agents.retrievers.specter import specter_agent
...
class RetrievalWorkflow:
    ...
    def visualize_graph(
        self, save_file: bool = False, filename: str = "workflow_graph.png"
    ):
        """
