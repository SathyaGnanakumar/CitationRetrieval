...
from src.additional.semantic_scholar_verifier import SemanticScholarCitationVerifier
...
def verifier_agent(state):
    ...
    return {"messages": [AIMessage(content=json.dumps(verified_results), name="verifier")]}
